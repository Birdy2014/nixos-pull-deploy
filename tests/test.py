...
class TestNixosDeploy(unittest.TestCase):
    def test(self) -> None:
        ...
        def run_mocked_deploy(target_commit: GitCommit):
            with unittest.mock.patch(
                ...
                self.assertEqual(deployed_branch, chosen_commit.commit)
        ...
        run_mocked_deploy(chosen_commit.commit)
        ...
        chosen_commit = nixos_deploy.get_commit_to_deploy()
        # FIXME: Change something so that this gets recognized as a new commit
